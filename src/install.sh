...
installPackages() {
	...
	if [[ ${file} == "full.txt" ]]; then
		...
		echo -e "│                                                                      │"
		echo -e "│    Steam requires Vulkan. Choose the driver that matches your GPU    │"
		echo -e "│         All Open-Source drivers are part of the Mesa project         │"
		echo -e "├──────────┬─────────────────────┬─────────────┬───────────────────────┤"
		echo -e "│ Platform │ Driver              │ License     │ Notes                 │"
		echo -e "├──────────┼─────────────────────┼─────────────┼───────────────────────┤"
		echo -e "│ Nvidia   │ nvidia-utils        │ Proprietary │ Recommended           │"
		echo -e "│          │ vulkan-nouveau      │ Open-Source │ Slower                │"
		echo -e "├──────────┼─────────────────────┼─────────────┼───────────────────────┤"
		echo -e "│ AMD      │ vulkan-radeon       │ Open-Source │ Recommended           │"
		echo -e "├──────────┼─────────────────────┼─────────────┼───────────────────────┤"
		echo -e "│ Intel    │ vulkan-intel        │ Open-Source │ Recommended           │"
		echo -e "│          │ vulkan-dzn          │ Open-Source │ DirectX 12 backend    │"
		echo -e "├──────────┼─────────────────────┼─────────────┼───────────────────────┤"
		echo -e "│ Apple    │ vulkan-asahi        │ Open-Source │ Apple Silicon (M1/M2) │"
		echo -e "├──────────┼─────────────────────┼─────────────┼───────────────────────┤"
		echo -e "│ ARM      │ vulkan-broadcom     │ Open-Source │ Raspberry Pi 4/5      │"
		echo -e "│          │ vulkan-freedreno    │ Open-Source │ Qualcomm Adreno       │"
		echo -e "│          │ vulkan-panfrost     │ Open-Source │ ARM Mali              │"
		echo -e "│          │ vulkan-powervr      │ Open-Source │ Imagination PowerVR   │"
		echo -e "│          │ vulkan-kosmickrisp  │ Open-Source │ Samsung Xclipse       │"
		echo -e "├──────────┼─────────────────────┼─────────────┼───────────────────────┤"
		echo -e "│ VM       │ vulkan-virtio       │ Open-Source │ Virtual Machines      │"
		echo -e "│          │ vulkan-gfxstream    │ Open-Source │ Android Emulator      │"
		echo -e "├──────────┼─────────────────────┼─────────────┼───────────────────────┤"
		echo -e "│ Fallback │ vulkan-swrast       │ Open-Source │ CPU only, very slow!  │"
		echo -e "└──────────┴─────────────────────┴─────────────┴───────────────────────┘"
		echo -e ""
