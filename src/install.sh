...
sudo pacman -Syy alacritty bash-completion code discord ffmpeg flameshot gimp gnome-color-manager gnu-free-fonts gst-libav gst-plugin-pipewire gst-plugin-gtk gst-plugins-bad gst-plugins-base gst-plugins-good gvfs gvfs-smb htop i3-wm lib32-pipewire loupe lxappearance-gtk3 nano neofetch nitrogen nvtop obs-studio pacman-contrib pamixer papirus-icon-theme pavucontrol pipewire pipewire-alsa pipewire-audio pipewire-jack pipewire-pulse polybar qt5-graphicaleffects qt5-svg qt5-quickcontrols2 rofi rtkit sddm sed steam totem ttf-jetbrains-mono ttf-jetbrains-mono-nerd udiskie unzip wget wireplumber xf86-input-evdev xf86-input-synaptics yt-dlp
